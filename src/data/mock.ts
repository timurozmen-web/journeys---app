...
export const trips: Trip[] = [
  {
    ...
    hotels: [
      { id: 'h1', name: 'Hilton Dalaman', country: 'Türkiye', brand: 'Hilton Honors', nights: 3, date: '2026-07-25', status: 'Completed', total: 480, nightlyRate: 160, avgRate: 190, sqm: null, card: 'Hilton Debit', category: 'Premium', lat: 36.7, lng: 28.8 },
      { id: 'h2', name: 'Maxx Royal Kemer', country: 'Türkiye', brand: 'Independent', nights: 3, date: '2026-08-04', status: 'Booked', total: 890, nightlyRate: 296, avgRate: 340, sqm: null, card: null, category: 'Luxury', lat: 36.5, lng: 30.5 },
      { id: 'h3', name: 'Maxx Royal Bodrum', country: 'Türkiye', brand: 'Independent', nights: 2, date: '2026-08-13', status: 'Booked', total: 620, nightlyRate: 310, avgRate: 350, sqm: null, card: null, category: 'Luxury', lat: 37.0, lng: 27.4 },
    ],
    flights: [
...
export const reviews: Review[] = [
  { hotelId: 'r1', hotelName: 'Taaktana Komodo', country: 'Indonesia', date: '2026-05', score: 10.0 },
  { hotelId: 'r2', hotelName: 'W Melbourne', country: 'Australia', date: '2026-05', score: 9.9 },
  { hotelId: 'r3', hotelName: 'Waldorf Astoria Bangkok', country: 'Thailand', date: '2025-07', score: 9.8 },
  { hotelId: 'r4', hotelName: 'St Regis Kanai', country: 'Mexico', date: '2026-02', score: 9.7 },
  { hotelId: 'r5', hotelName: 'Marriott Marble Arch', country: 'United Kingdom', date: '2026-07', score: 9.4 },
  { hotelId: 'r6', hotelName: 'Hilton Dalaman', country: 'Türkiye', date: '2026-07', score: 8.6 },
  { hotelId: 'r7', hotelName: 'Courtyard London City', country: 'United Kingdom', date: '2026-07', score: 5.8 },
];
